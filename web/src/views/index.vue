<template>
	<div class="index">
			...
			<header>
				<div class="container">
					<div class="logo-container">
						<router-link class="tag-line" style="font-size: 24px;color: #777777;" to="/">校园兼职平台</router-link>
					</div>
					<!-- Start of Main Navigation -->
					<nav class="main-nav">
						<div class="menu-top-menu-container">
							<ul id="menu-top-menu" >
								<li v-if='logining == 1'  style='padding:0px;color: #333;font-size: 16px;'>
									<a @click="closein">学生点此进行登录&nbsp;&nbsp;</a>
								</li>
								<el-dropdown v-else>
		...
		<div class="login" v-if="isclose">
			<div id="mask"></div>
			<div id="loginBox">
				<div style="text-align: center;">{{islogin?"登录":"注册"}}</div>
				<div class="user">
					账号：
				...
				<div class="button" v-if="islogin">
					...
					<el-button type="primary" @click="join">{{islogin?"注册":"登录"}}</el-button>
